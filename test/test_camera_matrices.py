...
class TestCameraMatrices:
    ...
    def test_intrinsic_matrix_basic_properties(self):
        ...
        intrinsic = intrinsic_matrix_from_params(focal_length, image_height, image_width)
    ...
    def test_intrinsic_matrix_with_skew(self):
        ...
        intrinsic = intrinsic_matrix_from_params(focal_length, image_height, image_width, skew)
